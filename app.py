...
model = torch.hub.load('ultralytics/yolov5', 'custom', path='C:/Users/PJ/Desktop/Drowsiness/yolov5/runs/train/exp9/weights/last.pt', force_reload=True)
